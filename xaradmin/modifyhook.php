...
function categories_admin_modifyhook($args)
{
    ...
    if (!xarSecurityCheck('EditCategoryLink', 0, 'Link', "$modid:$modtype:All:All")) {
        //we do not want to show an error message in the hook - the user just is not allowed to edit this hooked info
        //so just return and show nothing otherwise you end up with a No Access page where the hook should be
